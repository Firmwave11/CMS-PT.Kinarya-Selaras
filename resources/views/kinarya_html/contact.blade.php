                ...
                <div class="header-main">
                    <div class="menu-mobile">
                        <ul class="nav-links nav navbar-nav">
                            ...
                            <li class="active"><a href="contact.html" class="main-menu"><span class="text">contact</span></a></li>
                        </ul>
                                    ...
                                    <div class="wrapper-organization">
                                        <div class="col-md-4 col-sm-4 col-xs-4 md-organization">
                                            <div class="content-organization">
                                                <div class="wrapper-img"><img src="assets/images/homepage/avatar-contact-1.jpg" alt="" class="img img-responsive"></div>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4 md-organization">
                                            <div class="content-organization">
                                                <div class="wrapper-img"><img src="assets/images/homepage/avatar-contact-2.jpg" alt="" class="img img-responsive"></div>
                                                <div class="main-organization">
                                                    <div class="organization-title"> <a href="#" class="title">Jason Williams</a>
                                                        <p class="text">Commercial Director</p>
                                                    </div>
                                        ...
                                        <div class="col-md-4 col-sm-4 col-xs-4 md-organization">
                                            <div class="content-organization">
                                                <div class="wrapper-img"><img src="assets/images/homepage/avatar-contact-3.jpg" alt="" class="img img-responsive"></div>
                                                <div class="main-organization">
                                                    <div class="organization-title"> <a href="#" class="title">Jason Williams</a>
                                                        <p class="text">Commercial Director</p>
                                                    </div>
