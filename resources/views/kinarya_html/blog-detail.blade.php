...
<html lang="en">
    ...
    <head>
        <title>Exploore | Blog Detail</title>
        <meta charset="utf-8">
                                ...
                                <div class="page-title-wrapper">
                                    <div class="page-title-content">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active"><a href="#" class="link">blog detail</a></li>
                                        </ol>
                                        <div class="clearfix"></div>
                                        <h2 class="captions">BLOG DETAIL</h2></div>
                                </div>
                            </div>
                        </section>
                                        ...
                                        <div class="item-blog-detail">
                                            <div class="blog-post blog-text">
                                                <div class="blog-image">
                                                    <a href="javascript:void(0)" class="link"><img src="assets/images/blog/blog-image-1.jpg" alt="car on a road" class="img-responsive"></a>
                                                </div>
                                                <div class="blog-content margin-bottom70">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-11 blog-text"><a href="javascript:void(0)" class="heading"> Many people limit themselves what they think they can do.</a>
                                                            <h5 class="meta-info">Posted By : <span>John Smith</span><span class="sep">/</span><span class="view-count fa-custom">56</span><span class="comment-count fa-custom">259</span></h5>
                                                            <div class="blog-descritption">
                                                                ...
                                                                <div class="video-thumnail-wrap">
                                                                    <div class="video-thumbnail">
                                                                        <div class="video-bg"><img src="assets/images/blog/blog-detail.jpg" alt="" class="img-responsive"></div>
                                                ...
                                                <div class="blog-detail-tag tags-widget margin-bottom"><span class="content-tag">Tags:</span>
                                                    <div class="content-widget"><a href="javascript:void(0)" class="tag">Explore</a><a href="javascript:void(0)" class="tag">Adventure</a><a href="javascript:void(0)" class="tag">Traveler</a><a href="javascript:void(0)" class="tag">Europe</a>
                                                        <a
                                                            href="javascript:void(0)" class="tag">Big Your World</a>
                                                    </div>
                                                </div>
                                                <div class="blog-author margin-bottom">
                                                    <div class="media blog-author-content">
                                                        <div class="media-left">
                                                            <a class="media-image"><img src="assets/images/avatar/avatar-01.png" alt=""></a>
                                                        </div>
                                                    ...
                                                    <ul class="comment-list list-unstyled">
                                                        <li class="media parent">
                                                            <div class="comment-item">
                                                                <div class="media-left">
                                                                    <a class="media-image"><img src="assets/images/avatar/avatar-02.png" alt=""></a>
                                                                </div>
                                                                <div class="media-right">
                                                                    <div class="pull-left">
                                                                        <div class="author">Donna J. Walsh</div>
                                                                    </div>
                                                                    <div class="pull-right time"><i class="fa fa-clock-o"> </i><span>2 hours ago</span></div>
                                                                    <div class="clearfix"></div>
                                                                    ...
                                                                    <a
                                                                        href="#comment-form" class="btn-crystal btn"><i class="fa fa-reply"> </i>Reply</a>
                                                                </div>
                                                            </div>
                                                            <ul class="comment-list-children list-unstyled">
                                                                <li class="media child">
                                                                    <div class="comment-item">
                                                                        <div class="media-left">
                                                                            <a class="media-image"><img src="assets/images/avatar/avatar-03.png" alt=""></a>
                                                                        </div>
                                                                        <div class="media-right">
                                                                            <div class="pull-left">
                                                                            ...
                                                                            <div class="des">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam viverra euismod odio, gravida tesque urna varius vitae. Sed dui lorem, adipiscing in adipiscing et, interdum nec metus.
                                                                                </div><a href="#comment-form" class="btn-crystal btn"><i class="fa fa-reply"> </i>Reply</a></div>
                                                                    </div>
                                                                </li>
                                                                <li class="media child">
                                                                    <div class="comment-item">
                                                                        <div class="media-left">
                                                                            <a class="media-image"><img src="assets/images/avatar/avatar-04.png" alt=""></a>
                                                                        </div>
                                                                        <div class="media-right">
                                                                            <div class="pull-left">
                                                        ...
                                                        <li class="media parent">
                                                            <div class="comment-item">
                                                                <div class="media-left">
                                                                    <a class="media-image"><img src="assets/images/avatar/avatar-05.png" alt=""></a>
                                                                </div>
                                                                <div class="media-right">
                                                                    <div class="pull-left">
                                                ...
                                                <div class="leave-comment">
                                                    ...
                                                    <div class="form-group comment-form-rating">
                                                        ...
                                                        <p class="stars-rating"><span><a href="#" class="star-1">1</a><a href="#" class="star-2">2</a><a href="#" class="star-3">3</a><a href="#" class="star-4">4</a><a href="#" class="star-5">5</a></span></p>
                                                    </div>
                                                    <form id="comment-form" class="contact-form"><input type="text" placeholder="Your Name" class="form-control form-input"><input type="email" placeholder="Your Email" class="form-control form-input"><textarea placeholder="Your Message" class="form-control form-input"></textarea>
                                                        <div
                                                            class="contact-submit"></div><button type="submit" data-hover="SEND NOW" class="btn btn-slide"><span class="text">send message</span><span class="icons fa fa-long-arrow-right">  </span></button></form>
                                            </div>
                                        </div>
                                    </div>
                                </div>
