...
<html lang="en">
    ...
    <head>
        <title>Exploore | Tour View</title>
        <meta charset="utf-8">
        ...
        <link type="text/css" rel="stylesheet" href="assets/libs/fancybox/css/jquery.fancybox-buttons.css?v=1.0.5">
        <link type="text/css" rel="stylesheet" href="assets/libs/fancybox/css/jquery.fancybox-thumbs.css?v=1.0.7">
        <link type="text/css" rel="stylesheet" href="assets/libs/mouse-direction-aware/jquery.directional-hover.css">
                    ...
                    <div class="main-content">
                                ...
                                <div class="page-title-wrapper">
                                    <div class="page-title-content">
                                        <ol class="breadcrumb">
                                            ...
                                            <li><a href="hotel-result.html" class="link">tour</a></li>
                                            <li class="active"><a href="#" class="link">london tour</a></li>
                                        </ol>
                                        <div class="clearfix"></div>
                                        <h2 class="captions">london tour</h2>
                        ...
                        <section>
                            <div class="tour-view-main padding-top padding-bottom">
                                <div class="container">
                                    <h2 class="title-style-2">london tour <span> (sale off 30%)</span></h2>
                                    <div class="schedule-block">
                                        <div class="element">
                                            <p class="schedule-title">Date</p><span class="schedule-content">17 oct - 26 oct</span></div>
                                        <div class="element">
                                            <p class="schedule-title">Duration</p><span class="schedule-content">04 day</span></div>
                                        <div class="element">
                                            <p class="schedule-title">Reviews</p><span class="schedule-content">88</span></div>
                                        <div class="element">
                                            <p class="schedule-title">Guest Ratings</p><span class="schedule-content">4.5/5</span></div>
                                        <div class="element">
                                            <p class="schedule-title">Availability</p><span class="schedule-content">25</span></div>
                                    </div>
                                    <div class="journey-block margin-top70">
                                        <h3 class="title-style-3">Epic journeys</h3>
                                        <div class="wrapper-journey">
                                            <div class="item feature-item"><i class="icon-journey flaticon-interface"></i>
                                            ...
                                            <div class="item feature-item"><i class="icon-journey flaticon-money-1"></i>
                                            ...
                                            <div class="item feature-item"><i class="icon-journey flaticon-boat"></i>
                                                        ...
                                                        <div class="timeline-content medium-margin-top">
                                                            <div class="row">
                                                                ...
                                                                <div class="timeline-custom-col image-col">
                                                                    <div class="timeline-image-block"><img src="assets/images/tour-view/timeline/london.png" alt=""></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="timeline-block">
                                                        ...
                                                        <div class="timeline-content medium-margin-top">
                                                            <div class="row">
                                                                ...
                                                                <div class="timeline-custom-col image-col">
                                                                    <div class="timeline-image-block"><img src="assets/images/tour-view/timeline/nottingham.png" alt=""></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="timeline-block">
                                                        ...
                                                        <div class="timeline-content medium-margin-top">
                                                            <div class="row">
                                                                ...
                                                                <div class="timeline-custom-col image-col">
                                                                    <div class="timeline-image-block"><img src="assets/images/tour-view/timeline/birmingham.png" alt=""></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="timeline-block">
                                                        <div class="timeline-title"> <span>Day 04</span></div>
                                                        <div class="timeline-content medium-margin-top">
                                                            <div class="row">
                                                                <div class="timeline-point"><i class="fa fa-circle-o"></i></div>
                                                                <div class="timeline-custom-col content-col">
                                                                ...
                                                                <div class="timeline-custom-col image-col">
                                                                    <div class="timeline-image-block"><img src="assets/images/tour-view/timeline/manchester.png" alt=""></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="wrapper-btn margin-top70"><a href="#" class="btn btn-maincolor btn-book-tour">book now</a></div>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="grid">
                                            ...
                                            <div class="grid-item grid-item--big">
                                                <div class="gallery-image"><a href="assets/images/tour-view/grid-images/fancybox-1.png" data-fancybox-group="gallery" class="title-hover dh-overlay fancybox"><i class="icons fa fa-eye"></i></a>
                                                    <div class="bg"></div>
                                                </div>
                                            </div>
                                            <div class="grid-item grid-item--medium">
                                                <div class="gallery-image"><a href="assets/images/tour-view/grid-images/fancybox-2.png" data-fancybox-group="gallery" class="title-hover dh-overlay fancybox"><i class="icons fa fa-eye"></i></a>
                                                    <div class="bg"></div>
                                                </div>
                                            </div>
                                            <div class="grid-item img-small pdr">
                                                <div class="gallery-image"><a href="assets/images/tour-view/grid-images/fancybox-3.png" data-fancybox-group="gallery" class="title-hover dh-overlay fancybox"><i class="icons fa fa-eye"></i></a>
                                                    <div class="bg"></div>
                                                </div>
                                            </div>
                                            <div class="grid-item img-small pdl">
                                                <div class="gallery-image"><a href="assets/images/tour-view/grid-images/fancybox-4.png" data-fancybox-group="gallery" class="title-hover dh-overlay fancybox"><i class="icons fa fa-eye"></i></a>
                                                    <div class="bg"></div>
                                                </div>
                                            </div>
                                            <div class="grid-item grid-item--width2">
                                                <div class="gallery-image"><a href="assets/images/tour-view/grid-images/fancybox-5.png" data-fancybox-group="gallery" class="title-hover dh-overlay fancybox"><i class="icons fa fa-eye"></i></a>
                                                    <div class="bg"></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <ul class="nav list-time">
                                                    <li><span class="time"><i class="fa fa-long-arrow-right"></i>7 am - 4 pm Monday through Thursday.</span></li>
                                            ...
                                            <div class="col-md-6 col-sm-12 col-xs-12">
                                                <div class="about-us-wrapper">
                                                    <div class="avatar">
                                                        <div class="image-wrapper"><img src="assets/images/tour-view/avatar.jpg" alt="" class="img img-responsive"></div>
                                                        <div class="content-wrapper">
                                                            <p class="name">Peter Wilson</p>
                                                    ...
                                                    <div class="row group-list contact-list">
                                                        <div class="col-sm-4 col-xs-4 col-contact">
                                                            <div class="media contact-list-media">
                                                                <div class="media-left"><a href="#" class="icons"><i class="fa fa-desktop"></i></a></div>
                                                                <div class="media-right"><a href="#" class="title">Contact Skype</a>
                                                        ...
                                                        <div class="col-sm-4 col-xs-4 col-contact">
                                                            <div class="media contact-list-media">
                                                                ...
                                                                <div class="media-right"><a href="#" class="title">Phone</a>
                                                                    <p class="text">+1 (324) 317-8887</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-sm-4 col-xs-4 col-contact">
                                                            <div class="media contact-list-media">
                                                                ...
                                                                <div class="media-right"><a href="#" class="title">Email</a>
                                                                    <p class="text">peter.wilson@gmail.com</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
