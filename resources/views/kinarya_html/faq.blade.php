                                ...
                                <div class="page-title-wrapper">
                                    <div class="page-title-content">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="active"><a href="#" class="link">faq</a></li>
                                        </ol>
                                        <div class="clearfix"></div>
                                        <h2 class="captions">FAQ</h2></div>
                                </div>
                            </div>
                        </section>
                        <div class="page-main">
                                            ...
                                            <div class="col-md-8 col-sm-12 col-xs-12 main-right">
                                                <div class="wrapper-content-faq">
                                                    <div class="content-faq padding-bottom">
                                                        <h3 class="title-style-2">CHOOSING A TRIP</h3>
                                                        <div id="accordion-1" class="panel-group wrapper-accordion">
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-1-1" aria-expanded="false" class="accordion-toggle collapsed"> Travelling with childrend</a></h5></div>
                                                            ...
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-1-2" aria-expanded="false" class="accordion-toggle collapsed"> Travelling in a group</a></h5></div>
                                                            ...
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-1-3" aria-expanded="false" class="accordion-toggle collapsed">  Travelling solo</a></h5></div>
                                                            ...
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-1-4" aria-expanded="false" class="accordion-toggle collapsed"> Food, drink and dietary requirements</a></h5></div>
                                                            ...
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-1-5" aria-expanded="false" class="accordion-toggle collapsed"> Safety and medical information</a></h5></div>
                                                    ...
                                                    <div class="content-faq padding-bottom">
                                                        <h3 class="title-style-2">BEFORE YOU DEPART</h3>
                                                        <div id="accordion-2" class="panel-group wrapper-accordion">
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-2-1" aria-expanded="false" class="accordion-toggle collapsed"> Travel Insurance</a></h5></div>
                                                            ...
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-2-2" aria-expanded="false" class="accordion-toggle collapsed"> Visa Information</a></h5></div>
                                                            ...
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-2-3" aria-expanded="false" class="accordion-toggle collapsed">  Currency information</a></h5></div>
                                                            ...
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-2-4" aria-expanded="false" class="accordion-toggle collapsed"> What should I bring?</a></h5></div>
                                                            ...
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-2-5" aria-expanded="false" class="accordion-toggle collapsed"> Financial security</a></h5></div>
                                                    ...
                                                    <div class="content-faq">
                                                        ...
                                                        <div id="accordion-3" class="panel-group wrapper-accordion">
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-3-1" aria-expanded="false" class="accordion-toggle collapsed"> Arrival information</a></h5></div>
                                                            ...
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-3-2" aria-expanded="false" class="accordion-toggle collapsed"> Tipping information</a></h5></div>
                                                            ...
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-3-3" aria-expanded="false" class="accordion-toggle collapsed">  Keeping in touch with home</a></h5></div>
                                                            ...
                                                            <div class="panel">
                                                                <div class="panel-heading">
                                                                    <h5 class="panel-title"><a data-toggle="collapse" data-parent="#accordion-1" href="#collapse-3-4" aria-expanded="false" class="accordion-toggle collapsed"> Accommodation and Transport</a></h5></div>
                                            ...
                                            <div class="col-md-4 col-sm-12 col-xs-12 wrapper-contact-faq">
                                                <div class="contact-wrapper">
                                                    <div class="contact-box">
                                                        ...
                                                        <form class="contact-form"><input type="text" placeholder="Name" class="form-control form-input">
                                                            <!--label.control-label.form-label.warning-label(for="") Warning for the above !--><input type="email" placeholder="Email" class="form-control form-input">
                                                            <!--label.control-label.form-label.warning-label(for="") Warning for the above !--><textarea placeholder="Question" class="form-control form-input"></textarea>
                                                            <div class="contact-submit"><button type="submit" data-hover="SEND NOW" class="btn btn-slide"><span class="text">send question</span><span class="icons fa fa-long-arrow-right"></span></button></div>
                                                        </form>
                                                    </div>
                                                </div>
                                            </div>
